...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10/11/2025 às 15:40
...
(106, 'Caramelo', 87, 'cachorro', 'chow_chow', NULL, NULL, NULL, NULL, 2, 'M', 'Caramelo', '2025-05-25', '/uploads/ff6986fc2254998825287ed913c6f31c.jpeg', NULL),
...
(24, 'vacina_v10_cao', 'Polivalente V8 ou V10 (Cinomose, Parvovirose, etc.)', NULL, '0000-00-00', 1, 106),
...
--
ALTER TABLE `medicamentos`
  MODIFY `id_medicamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de tabela `pets`
--
ALTER TABLE `pets`
  MODIFY `id_pet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `vacinas`
  MODIFY `id_vacina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
